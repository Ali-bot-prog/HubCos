...
const menuItems = [
    { name: "Genel Bakış", href: "/yonetim", icon: LayoutDashboard },
    { name: "Site Tasarımı", href: "/yonetim/design", icon: Paintbrush },
    { name: "Menü / Sidebar", href: "/yonetim/menu", icon: PanelLeft },
    { name: "Blog Yazıları", href: "/yonetim/blog", icon: FileText },
    { name: "S.S.S (FAQ)", href: "/yonetim/faq", icon: HelpCircle },
    { name: "Footer", href: "/yonetim/footer", icon: PanelBottom },
    { name: "İçerik Yönetimi", href: "/yonetim/content", icon: FileText },
    { name: "Projeler", href: "/yonetim/projects", icon: FolderKanban },
    { name: "Mesajlar", href: "/yonetim/messages", icon: MessageSquare },
    { name: "Yöneticiler", href: "/yonetim/users", icon: Users },
  ];
    ...
    <div className="flex h-screen bg-gray-900 text-white">
      ...
      <aside className="w-64 bg-gray-800 border-r border-gray-700 flex flex-col hidden md:flex">
        ...
        <div className="p-4 border-t border-gray-700">
          <button
            onClick={() => signOut({ callbackUrl: "/yonetim/login" })}
