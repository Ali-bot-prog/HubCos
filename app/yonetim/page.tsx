  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        ...
        <Link href="/yonetim/dashboard-settings" className="p-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors" title="Dashboard Düzenle">
        ...
        {config.showQuickActions && (
            <div className="bg-gray-800 p-6 rounded-2xl border border-gray-700">
                ...
                <div className="flex flex-wrap gap-4">
                    <Link href="/yonetim/projects/new" className="bg-[#2D3748] hover:bg-gray-600 px-4 py-2 rounded-lg text-sm transition-colors text-white inline-block">
                        Yeni Proje Ekle
                    </Link>
                    <Link href="/yonetim/content" className="bg-[#2D3748] hover:bg-gray-600 px-4 py-2 rounded-lg text-sm transition-colors text-white inline-block">
                        Siteyi Düzenle
                    </Link>
                     <Link href="/yonetim/menu" className="bg-[#2D3748] hover:bg-gray-600 px-4 py-2 rounded-lg text-sm transition-colors text-white inline-block">
                        Menüyü Düzenle
                    </Link>
                </div>
            </div>
