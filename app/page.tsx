    ...
    <div className="flex flex-col pb-0">
      ...
      >
        ...
        <div className="container mx-auto px-4 z-20 relative">
          <FadeIn delay={0.1}>
            <h1 
                className="font-black mb-8 tracking-tighter leading-tight uppercase"
                style={{ 
                    color: config.heroTitleColor || '#ffffff', 
                    fontSize: config.heroTitleSize === 'text-6xl' ? '4rem' : '3rem' // Simple mapping, could be better
                }}
            >
              {heroTitle}
            </h1>
          ...
          <FadeIn delay={0.3}>
            <p 
                className="mb-12 max-w-3xl mx-auto font-light leading-relaxed tracking-wide text-xl md:text-2xl"
          ...
          <FadeIn delay={0.5}>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
               <Link
                href="/projeler"
                className="px-12 py-5 text-lg font-bold transition-all transform hover:translate-y-[-2px] tracking-widest uppercase hover:opacity-90"
      ...
      {/* About Section */}
      <section className="py-32 container mx-auto px-4" style={{ backgroundColor: config.aboutBackgroundColor || 'transparent' }}>
        <div className="flex flex-col md:flex-row gap-20 items-center">
          ...
          <div className="w-full md:w-1/2">
            <Reveal>
              <h2 className="text-sm font-black tracking-[0.2em] uppercase mb-4" style={{ color: config.primaryColor }}>Hakkımızda</h2>
            </Reveal>
            <Reveal>
              <h3 className="text-5xl md:text-6xl font-black mb-8 leading-tight" style={{ color: config.headingColor }}>
                {config.aboutTitle || "MÜHENDİSLİK VE PERFORMANS"}
              </h3>
            </Reveal>
            <Reveal>
              <p className="mb-10 leading-relaxed text-xl font-light" style={{ color: config.aboutTextColor || config.bodyColor }}>
      ...
      {/* Services Section */}
      <section className="py-32 border-t border-gray-800" style={{ backgroundColor: config.cardBackgroundColor || '#171717' }}>
        <div className="container mx-auto px-4">
           {/* ... Header ... */}
           <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-10">
              <div className="max-w-2xl">
                <Reveal width="100%">
                  <h2 className="text-sm font-black tracking-[0.2em] uppercase mb-4" style={{ color: config.primaryColor }}>Faaliyet Alanları</h2>
                  <h3 className="text-5xl font-black leading-tight" style={{ color: config.headingColor }}>ENDÜSTRİYEL ÇÖZÜMLER</h3>
                </Reveal>
              </div>
           </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-t border-l border-gray-800">
            {(content?.services || [
              ...
              <FadeIn delay={0.2 * (i + 1)} key={service.id || i}>
                <div className="p-12 hover:bg-white/5 transition-all duration-500 group border-r border-b border-gray-800 h-full">
                  <div className="mb-10 group-hover:scale-110 transition-transform" style={{ color: config.primaryColor }}>
                    <Icon name={service.icon} className="w-16 h-16" />
                  </div>
                  <h3 className="text-2xl font-bold mb-6" style={{ color: config.headingColor }}>{service.title}</h3>
                  <p className="leading-relaxed text-lg" style={{ color: config.bodyColor }}>
                    {service.description}
                  </p>
                </div>
              </FadeIn>
      ...
      <section className="bg-neutral-950 py-32 border-t border-gray-800">
         <div className="container mx-auto px-4">
             <div className="flex justify-between items-end mb-20">
                <div>
                     <Reveal>
                        <h2 className="text-sm font-black tracking-[0.2em] uppercase mb-4" style={{ color: config.primaryColor }}>Referanslar</h2>
                        <h3 className="text-5xl font-black" style={{ color: config.headingColor }}>DEV PROJELER</h3>
                     </Reveal>
                </div>
                {/* ... Link ... */}
             </div>
